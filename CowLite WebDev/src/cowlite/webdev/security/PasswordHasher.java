package cowlite.webdev.security;
...
public class PasswordHasher
{
    ...
    public static final int DEFAULT_ITERATIONS = 300000;
    ...
    {
        hash(salt, "SHA-256", DEFAULT_ITERATIONS);
    }
    
    public void hash(String salt, int iterations) throws Exception {
        hash(salt, "SHA-256", iterations);
    }
    
    public void hash(String salt, String algorithm) throws Exception {
        hash(salt, algorithm, DEFAULT_ITERATIONS);
    }
    
    public void hash(String salt, String algorithm, int iterations) throws Exception {
        if(password == null)
            throw new Exception("No password has been set to be hashed.");
        
        hash = "";
        for(int i = 0; i < iterations; i++) {
            String salted = password + salt + hash;
