package cowlite.webdev.database;

import java.sql.Connection;
import java.sql.SQLException;

/**
 * This class forms the basis for all DataBase Access Objects (DBAO) used in Exhale.
...
public abstract class DBAO 
{
     ...
     * to a database. It turns off autocommit and makes transactions serializable. 
